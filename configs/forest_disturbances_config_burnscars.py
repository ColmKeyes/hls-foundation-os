...
data_root = r"E:\Data\Sentinel2_data\30pc_cc\Tiles_512_30pc_cc\globalnorm\15000_minalerts"
...
means = [0.11349006921130662, 0.18013922190434992, 0.09824706480197842, 0.5221330166878408, 0.3583233, 0.34587905],#0.03025329, 0.07961972], #0.31299707170569835, 0.15978379676331667],
stds = [0.073205091376172, 0.08175555163630563, 0.07270076782812802, 0.11422985057904868,0.16327385, 0.15160857]#0.01407666, 0.03714384] #0.10197667925518768, 0.08313405470923486]
)
...
img_suffix = "_sentinel_agb_normalized.tif"  #"radd_modified_sentinel_normalized_agb.tif"
...
pretrained_weights_path = r"E:\burn_scars_Prithvi_100M.pth" ## burn_scars_Prithvi_100M.pth#E:\Prithvi_100M.pt
num_layers = 12
patch_size = 16
embed_dim = 768
num_heads = 12
...
# TO BE DEFINED BY USER: model path
experiment = "Prithvi-100m_burnscars"
