...
img_suffix = "_sentinel_agb_normalized_coh_masked_normalized.tif"#"_sentinel_agb_normalized.tif"  #"radd_modified_sentinel_normalized_agb.tif"
...
# TO BE DEFINED BY USER: model path
experiment = "Prithvi-100m_coherence"
