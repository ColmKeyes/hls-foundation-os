...
base_ckpt_path = r"C:\PycharmProjects\hls-foundation-os"
base_output_path = r"C:\PycharmProjects\hls-foundation-os\test_image_results"
base_config_path = r"C:\PycharmProjects\hls-foundation-os\configs"
# base_input_path = r"C:\Data\Sentinel2_data\30pc_cc\Tiles_512_30pc_cc\globalnorm"

test_path = r"F:\Data\hls_foundation_os\test"


model_config_pairs = [
     (r"models\best_mIoU_iter_500_minalerts_12500_prithvi_final_run4_op.pth", "forest_disturbances_config_coherence.py"),]
...
for model, config in model_config_pairs:
    ...
    # else:
    input_path = test_path #os.path.join(base_input_path, "15000_minalerts/test/")
